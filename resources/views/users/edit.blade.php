...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Modification de {{ $user->name }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small id="passwordHelpBlock" class="form-text text-muted">
                                  💡 Pour ne pas changer le mot de passe, laissez le champs vide.
                                </small>
                ...
                @if(auth()->user()->email == config('chyz.admin-email'))
